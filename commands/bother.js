...
module.exports = {
	...
	async execute(interaction) {
        ...
        const randomvids = [
            ...
            './videos/table_scare.mp4', './videos/segs.mp4', './videos/tumingin.mp4', './videos/nike.mp4', './videos/deadbydaylight.mp4', './videos/sinkomomentos.mp4', './videos/platinum.mp4', './videos/horsecat.mp4', './videos/plane.mp4'
        ];
