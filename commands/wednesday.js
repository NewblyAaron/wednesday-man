...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .addBooleanOption((option) =>
      option
        .setName("always_wednesday")
        .setDescription(
          "Replies like it is a Wednesday, regardless of the current day of the week.",
        )
        .setRequired(false),
    ),
